...
export function FutureResources() {
  ...
  const resources: Array<[string, string, string]> = fr
    ? [
        ["Le manifeste", "Comprendre la vision du temps partagé et de l'action collective.", "https://temposystem.fr"],
    ...
    : [
        ["Manifesto", "Understand the vision for shared time and collective action.", "https://temposystem.fr"],
