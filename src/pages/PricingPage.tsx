  ...
  >
    ...
    <section className="offer-section">
      <div className="offer-wrap">
        ...
        {/* Illustration « archipel des configurations » masquée : le PNG
            /illustrations/configurations-archipel.png est corrompu (IDAT tronqué,
            ~80% noir). À restaurer dès qu'une version saine est fournie. */}
