 ...
 *
 * Cette passe est VOLONTAIREMENT SOBRE : silhouette, proportions, composition,
 * lisibilité. Aucune animation, aucun filtre, aucun halo, aucun dégradé, aucun
 * effet lumineux. Les effets viendront à l'étape suivante.
 *
 * Perf : un seul SVG, formes consolidées (un <path>/<polygon> par couleur quand
 * c'est lisible), ≤ 35 éléments graphiques, aucune dépendance, aucun calcul au
 * rendu. Décoratif → aria-hidden.
 */
